...
async def authorize_airtable_integration(
    ...
    return await authorize_airtable(
        user_id,
        org_id,
    )
...
async def oauth2callback_airtable_integration(
    request: Request,
):
    return await oauth2callback_airtable(
        request
    )
...
async def get_airtable_credentials_integration(
    ...
    return await get_airtable_credentials(
        user_id,
        org_id,
    )
...
async def get_airtable_items_integration(
    credentials: str = Form(...),
):
    return await get_items_airtable(
        credentials
    )
...
async def oauth2callback_notion_integration(
    request: Request,
):
    return await oauth2callback_notion(
        request
    )
...
async def get_notion_credentials_integration(
    ...
    return await get_notion_credentials(
        user_id,
        org_id,
    )
...
async def get_notion_items_integration(
    credentials: str = Form(...),
):
    return await get_items_notion(
        credentials
    )
...
async def authorize_hubspot_integration(
    ...
    return await authorize_hubspot(
        user_id,
        org_id,
    )
...
async def oauth2callback_hubspot_integration(
    request: Request,
):
    return await oauth2callback_hubspot(
        request
    )
...
async def get_hubspot_credentials_integration(
    ...
    return await get_hubspot_credentials(
        user_id,
        org_id,
    )
...
async def get_hubspot_items_integration(
    credentials: str = Form(...),
):
